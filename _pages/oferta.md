...
1.1. ИП «inji», в лице Управляющего директора TODO, действующей на основании Устава, именуемое в дальнейшем «Агент», размещает настоящую Публичную оферту о заказе с последующей доставкой товаров повседневного спроса на Сайте [https://inji.kz](https://inji.kz) (далее — Сайт).
